...
gsudo Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process; $PSScriptRoot\2-enable-windows-features.ps1; $PSScriptRoot\3-install-chocolatey.ps1; $PSScriptRoot\4-install-software.ps1
Write-Host "Done" -ForegroundColor Yellow
